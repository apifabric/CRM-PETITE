...
resourcename="crm-petite"  # lower case, only
resourcegroup="crm-petite_rg"
...
# git clone https://github.com/apilogicserver/crm-petite.git
# cd crm-petite
...
az group create --name crm-petite_rg --location "westus"
az appservice plan create --name myAppServicePlan --resource-group crm-petite_rg --sku S1 --is-linux
az container create --resource-group crm-petite_rg --name crm-petite --image apilogicserver/crm-petite:latest --dns-name-label crm-petite --ports 5656 --environment-variables 'VERBOSE'='True'  'APILOGICPROJECT_CLIENT_URI'='//crm-petite.westus.azurecontainer.io:5656'
